...
class TestIo(unittest.TestCase):
    ...
    from .io.gzip_file import test_gzip_file_read, test_gzip_file_write
    from .io.fastq_file import test_fastq_file_gzip_read, test_fastq_file_raw_read, test_fastq_file_gzip_write
